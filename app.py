...
def inject_custom_css():
    ...
    .inventory-card { background-color: #ffffff; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border: 1px solid #e2e8f0; margin-bottom: 15px; }
    ...
    .shift-container { background-color: #ffffff; padding: 15px; border-radius: 8px; border: 1px solid #cbd5e1; margin-bottom: 20px; font-family: sans-serif; }
    .shift-title { font-size: 14px; font-weight: 700; color: #1e293b; margin-bottom: 12px; border-bottom: 2px solid #e2e8f0; padding-bottom: 6px; }
    .shift-row { font-size: 13.5px; margin-bottom: 8px; color: #334155; line-height: 1.4; }
    .emp-names { font-weight: 700 !important; color: #0f172a !important; }
    </style>
    """
